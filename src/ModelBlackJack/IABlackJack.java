...
// Clase que representa la lógica de la inteligencia artificial (IABlackJack) del croupier
public class IABlackJack {
    ...
    // Método que aplica reglas de la IABlackJack para tomar decisiones basadas en el nivel de dificultad
    public static int rule(int difficultyLevel, PlayerBlackJack croupier) {
        int targetScore;
